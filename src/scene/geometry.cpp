...
void Geometry::init(int stepVertex, int stepColor,
                    int stepTexCoords, ps::opengl::GLFaceType faceMode) {
    this->cleanup();
...
bool Geometry::addFaceIndices(const vector<U32>& arrIndex, GLFaceType faceMode) {
